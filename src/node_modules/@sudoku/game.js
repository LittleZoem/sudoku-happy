...
/**
 * Start new game with an sudoku imported from sudoku.wiki url
 *
 * @param {string} urlcode - url to decode
 */
export function startImport(urlcode) {
	difficulty.setCustom();
	grid.decodeUrlcode(urlcode);
	cursor.reset();
	timer.reset();
	hints.reset();
	strategyTrack.clear();
